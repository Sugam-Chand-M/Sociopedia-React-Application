...
const MyPostWidget=({picturePath})=>{
    ...
    const handlePost=async()=>{ // handles the post and makes the api call
        const formData=new FormData();
        formData.append("userId",_id);
        formData.append("description",post);
        if(image){ // in server/index.js we have an app.post() method where the attched image is taken care of
