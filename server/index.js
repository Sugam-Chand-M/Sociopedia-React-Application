...
app.post("/posts",verifyToken,upload.single("picture"),createPost); // when we send a picture from the frontend it grabs the picture property and upload it in the local
...
mongoose.connect(process.env.MONGO_URL,{
    ...
    // injecting the data manually just only for one time
